...
$pagina="Confidencial";
	...
	//DOCUMENTOS Y VIDEOS
	$rst_query2=mysqli_query($conexion, "SELECT * FROM ap_confidencial WHERE id>0 AND publicar=1 ORDER BY id DESC LIMIT 5");
	...
	$rst_query2=mysqli_query($conexion, "SELECT * FROM ap_confidencial WHERE id>0 AND publicar=1 ORDER BY id DESC LIMIT $inicio, $registros;");
...
<title>Intranet - Confidencial</title>
...
<div id="interior-sombra">
              ...
              <div id="contenido525">
              <div id="div-ancho100">
                <p class="texto-negro15-MyriadProBold">CONFIDENCIAL</p>
                <p class="texto-negro11-Arial">&nbsp;</p>
</div>
