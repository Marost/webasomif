...
$pagina="Confidencial";
	...
	//DOCUMENTOS Y VIDEOS
	$rst_query2=mysql_query("SELECT * FROM ap_confidencial WHERE id>0 AND publicar=1 ORDER BY id DESC LIMIT 5", $conexion);
	...
	$rst_query2=mysql_query("SELECT * FROM ap_confidencial WHERE id>0 AND publicar=1 ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
