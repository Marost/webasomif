...
$pagina="Estadística";
	...
	//DOCUMENTOS Y VIDEOS
	$rst_query2=mysql_query("SELECT * FROM ap_estadistica WHERE id>0 AND publicar=1 ORDER BY id DESC LIMIT 5", $conexion);
	...
	$rst_query2=mysql_query("SELECT * FROM ap_estadistica WHERE id>0 AND publicar=1 ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
		
	//DOCUMENTOS VIDEOS
	//$rst_query2=mysql_query("SELECT * FROM ap_estadistica WHERE id>0 AND tipo='Documento' AND publicar=1 ORDER BY id DESC LIMIT 4", $conexion);
	//$rst_query3=mysql_query("SELECT * FROM ap_estadistica WHERE id>0 AND tipo='Video' AND publicar=1 ORDER BY id DESC LIMIT 4", $conexion);
