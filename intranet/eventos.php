...
<title>Intranet - Eventos y Actividades</title>
...
<div id="interior-sombra">
              ...
              <div id="contenido525">
              <div id="div-ancho100">
                <p class="texto-negro15-MyriadProBold">EVENTOS Y ACTIVIDADES</p>
                <p class="texto-negro11-Arial">Información detallada y actualizada de cada evento y/o actividad que ofrecemos a nuestras asociadas. Todos los temas de interés a su alcance.  Compártalo entre los miembros de su institución. Remita información que considere pertinente difundirla.</p>
                <p>&nbsp;</p>
                </div>
                    ...
                    <?php }elseif($fila_query2["tipo"]=='Video'){ ?>
                      <div id="documentos-pdf-doc">
                                <div id="icon-pdf-doc">
                                    ...
                                    <form action="conexion/guardarDescarga.php?tipo_pagina=evento" method="post" id="video<?php echo $fila_query2["id"]; ?>" onsubmit="abrirVentana('video.php?id=<?php echo $fila_query2["id"]; ?>&tipo_pagina=evento','video','width=640,height=385')">
