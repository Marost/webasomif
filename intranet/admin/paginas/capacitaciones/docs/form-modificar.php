...
header("Content-Type: text/html; charset=utf-8");
	...
	$rst_query=mysqli_query($conexion, "SELECT * FROM ap_capac_docs WHERE id=". $_REQUEST["id"].";");
                ...
                <form action="actualizar.php?id=<?php echo $_REQUEST["id"]; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
            	  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
            	    ...
            	    <tr>
            	      ...
            	      <td align="left"><input type="file" name="documento" id="documento" /></td>
          	      </tr>
            	    <tr>
            	      <td align="center"><p><strong>Documento Actual:</strong></p></td>
            	      <td align="left"><p>
					  <?php 
					  $archivo=explode("=",$fila_query["nombre_archivo"]);
					  echo $archivo[1];
					  ?>
