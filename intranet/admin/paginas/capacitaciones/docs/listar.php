...
$buscar=$_REQUEST["busqueda"];
	...
	{
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_capac_docs WHERE id>0 AND tipo='Documento' ORDER BY taller ASC;");
		...
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_capac_docs WHERE id>0 AND tipo='Documento' ORDER BY taller ASC LIMIT $inicio, $registros;");
	...
	{
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_capac_docs WHERE taller LIKE '%$buscar%' AND tipo='Documento' ORDER BY taller ASC;");
		$num_registros=mysqli_num_rows($rst_query);
		...
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_capac_docs WHERE taller LIKE '%$buscar%' AND tipo='Documento' ORDER BY taller ASC LIMIT $inicio, $registros;");
		$paginas=ceil($num_registros/$registros);
...
<link rel="stylesheet" type="text/css" href="../../../css/style-listas.css">
    ...
    <div id="contenido">
            	<div id="titulo_principal">
            	  <h2>Lista - Capacitacion / Documentos</h2>
