...
$buscar=$_REQUEST["busqueda"];
	...
	{
		$rst_query=mysql_query("SELECT * FROM ap_capac_docs WHERE id>0 AND tipo='Video' ORDER BY taller ASC;", $conexion);
		...
		$rst_query=mysql_query("SELECT * FROM ap_capac_docs WHERE id>0 AND tipo='Video' ORDER BY taller ASC LIMIT $inicio, $registros;", $conexion);
	...
	{
		$rst_query=mysql_query("SELECT * FROM ap_capac_docs WHERE taller LIKE '%$buscar%' AND tipo='Video' ORDER BY taller ASC;", $conexion);
		$num_registros=mysql_num_rows($rst_query);
		...
		$rst_query=mysql_query("SELECT * FROM ap_capac_docs WHERE taller LIKE '%$buscar%' AND tipo='Video' ORDER BY taller ASC LIMIT $inicio, $registros;", $conexion);
		$paginas=ceil($num_registros/$registros);
