...
mysql_query("INSERT INTO ap_confidencial (taller, lugar_fecha, programa, nombre_archivo, extension, publicar, tipo)
VALUES('$taller', '$lugar_fecha', '$programa', '$documento', '$extension', $publicar, '$tipo');",$conexion);
