...
mysql_query("UPDATE ap_confidencial SET taller='$taller', lugar_fecha='$lugar_fecha', programa='$programa', nombre_archivo='$documento', extension='$extension', publicar=$publicar, tipo='$tipo' WHERE id=". $_REQUEST["id"].";", $conexion);
