...
<div id="contenido">
  <div id="titulo_principal">
   	<h2>Modificar - Capacitaci&oacute;n</h2>
                ...
                <form action="actualizar.php?id=<?php echo $_REQUEST["id"]; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
            	  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
            	      ...
            	      <td height="35"><span id="spryselect">
            	        <label>
            	          <select name="publicar" id="publicar3">
            	            ...
            	            <?php while ($fila1=mysqli_fetch_array($rst_publicar)){                                if ($fila1["id"]==$fila_query["publicar"])
            	    ...
            	    <tr>
            	      ...
            	      <td align="left"><span class="texto_der">
            	        <input name="documento" type="text" id="documento" size="50" />
          	        </span></td>
          	      </tr>
            	    <tr>
            	      <td align="center"><p><strong>Documento Actual:</strong></p></td>
            	      <td align="left"><p>
            	        <?php 
					  $archivo=$fila_query["nombre_archivo"];
					  echo $archivo;
					  ?>
            	        <input name="doc-actual" type="hidden" id="doc-actual" value="<?php echo $fila_query["nombre_archivo"] ?>" />
          	        </p></td>
          	      </tr>
            	    <tr>
            	    ...
            	    <tr>
            	      ...
            	      <td align="left"><img src="../../../../imagenes/upload/<?php echo $fila_query["logo"] ?>" />
           	          <input name="logo-actual" type="hidden" id="logo-actual" value="<?php echo $fila_query["logo"] ?>" /></td>
          	      </tr>
                <tr>
