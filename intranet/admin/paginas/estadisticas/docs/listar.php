...
$buscar=$_REQUEST["busqueda"];
	...
	{
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_estadistica WHERE id>0 AND tipo='Documento' ORDER BY taller ASC;");
		...
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_estadistica WHERE id>0 AND tipo='Documento' ORDER BY taller ASC LIMIT $inicio, $registros;");
	...
	{
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_estadistica WHERE taller LIKE '%$buscar%' AND tipo='Documento' ORDER BY taller ASC;");
		$num_registros=mysqli_num_rows($rst_query);
		...
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_estadistica WHERE taller LIKE '%$buscar%' AND tipo='Documento' ORDER BY taller ASC LIMIT $inicio, $registros;");
		$paginas=ceil($num_registros/$registros);
...
if(confirm("¿Está seguro de borrar este registro?")) {
    ...
    <div id="contenido">
            	<div id="titulo_principal">
            	  <h2>Lista - Estadisticas / Documentos</h2>
                ...
                <div id="contenido_total">
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td width="28%" height="30" align="center"><p><a href="form-agregar.php"><strong>Agregar Documento</strong></a></p></td>
                      ...
                      <td colspan="2"><table width="95%" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <td width="3%" align="center"><a onclick="eliminarRegistro(<?php echo $fila["id"] ?>);" href="javascript:;"><img src="../../../images/eliminar_16.png" width="16" height="16" title="Eliminar registro" /></a></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                      </table></td>
