...
$buscar=$_REQUEST["busqueda"];
	...
	{
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_estadistica WHERE id>0 AND tipo='Video' ORDER BY taller ASC;");
		...
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_estadistica WHERE id>0 AND tipo='Video' ORDER BY taller ASC LIMIT $inicio, $registros;");
	...
	{
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_estadistica WHERE taller LIKE '%$buscar%' AND tipo='Video' ORDER BY taller ASC;");
		$num_registros=mysqli_num_rows($rst_query);
		...
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_estadistica WHERE taller LIKE '%$buscar%' AND tipo='Video' ORDER BY taller ASC LIMIT $inicio, $registros;");
		$paginas=ceil($num_registros/$registros);
...
if(confirm("¿Está seguro de borrar este registro?")) {
    ...
    <div id="contenido">
            	<div id="titulo_principal">
            	  <h2>Lista -  Estadisticas / Video</h2>
