...
$buscar=$_REQUEST["busqueda"];
	...
	{
		$rst_query=mysql_query("SELECT * FROM ap_noticias WHERE id>0 ORDER BY id DESC;", $conexion);
		...
		$rst_query=mysql_query("SELECT * FROM ap_noticias WHERE id>0 ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
	...
	{
		$rst_query=mysql_query("SELECT * FROM ap_noticias WHERE titulo LIKE '%$buscar%' ORDER BY id DESC;", $conexion);
		$num_registros=mysql_num_rows($rst_query);
		...
		$rst_query=mysql_query("SELECT * FROM ap_noticias WHERE titulo LIKE '%$buscar%' ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
		$paginas=ceil($num_registros/$registros);
