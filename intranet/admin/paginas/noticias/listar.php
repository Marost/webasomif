...
$buscar=$_REQUEST["busqueda"];
	...
	{
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_noticias WHERE id>0 ORDER BY id DESC;");
		...
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_noticias WHERE id>0 ORDER BY id DESC LIMIT $inicio, $registros;");
	...
	{
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_noticias WHERE titulo LIKE '%$buscar%' ORDER BY id DESC;");
		$num_registros=mysqli_num_rows($rst_query);
		...
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_noticias WHERE titulo LIKE '%$buscar%' ORDER BY id DESC LIMIT $inicio, $registros;");
		$paginas=ceil($num_registros/$registros);
                      ...
                      <td><table width="95%" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                        <thead>
                          <tr class="titulo-campo">
                            <th width="50%" height="25">titulo</th>
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            <td width="50%"><p><strong class="up"><?php echo stripslashes(htmlspecialchars($fila["titulo"])) ?></strong></p></td>
