...
$buscar=$_REQUEST["busqueda"];
		...
		$rst_query=mysql_query("SELECT * FROM ap_sugerencia_contacto WHERE id>0 ORDER BY id DESC;", $conexion);
		...
		$rst_query=mysql_query("SELECT * FROM ap_sugerencia_contacto WHERE id>0 ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
