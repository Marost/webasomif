...
mysqli_query($conexion, "INSERT INTO ap_consulta_legal (persona, email, mensaje, identificador, respuesta) VALUES('$persona', '$email', '$mensaje', $identificador, $respuesta);");
