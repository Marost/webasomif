...
$buscar=$_REQUEST["busqueda"];
	...
	{
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_eventos WHERE id>0 AND tipo='Video' ORDER BY taller ASC;");
		...
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_eventos WHERE id>0 AND tipo='Video' ORDER BY taller ASC LIMIT $inicio, $registros;");
	...
	{
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_eventos WHERE taller LIKE '%$buscar%' AND tipo='Video' ORDER BY taller ASC;");
		$num_registros=mysqli_num_rows($rst_query);
		...
		$rst_query=mysqli_query($conexion, "SELECT * FROM ap_eventos WHERE taller LIKE '%$buscar%' AND tipo='Video' ORDER BY taller ASC LIMIT $inicio, $registros;");
		$paginas=ceil($num_registros/$registros);
