...
mysql_query("INSERT INTO ap_eventos (taller, lugar_fecha, programa, nombre_archivo, extension, publicar, tipo, logo) VALUES('$taller', '$lugar_fecha', '$programa', '$documento', '$extension', $publicar, '$tipo', '$name');",$conexion);
